...
json -I -f angular.json -e "this.schematics['@nrwl/angular:application'].prefix = $PREFIX;"
...
json -I -f angular.json -e "this.schematics['@nrwl/angular:library'].prefix = $PREFIX;"
