...
json -I -f apps/$APPNAME/tsconfig.json -e "this.compilerOptions.strict = true;"
echo "this.compilerOptions.strict = true"
json -I -f apps/$APPNAME/tsconfig.json -e "this.compilerOptions.noImplicitReturns = true;"
echo "this.compilerOptions.noImplicitReturns = true"
json -I -f apps/$APPNAME/tsconfig.json -e "this.compilerOptions.noFallthroughCasesInSwitch = true;"
echo "this.compilerOptions.noFallthroughCasesInSwitch = true"
json -I -f apps/$APPNAME/tsconfig.json -e "this.angularCompilerOptions = { };"
echo "this.angularCompilerOptions = { }"
json -I -f apps/$APPNAME/tsconfig.json -e "this.angularCompilerOptions.strictInjectionParameters = true;"
echo "this.angularCompilerOptions.strictInjectionParameters = true"
json -I -f apps/$APPNAME/tsconfig.json -e "this.angularCompilerOptions.strictTemplates = true;"
